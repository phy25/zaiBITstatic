...
相片
	...
	但是在部分纸质材料中仍需粘贴相片，开学【可能】会用到几张。建议你准备 1 寸、2 寸的蓝、白背景彩照各一版，其中 1 寸用得比较多，2 寸备用几张即可。
...
自行车
	是否需要自行车与宿舍位置有关，如果不是住在丹枫园、博雅园的话，校区内的步行距离还是很短的。丹枫园、博雅园分别位于校区的北、南端，从这两个宿舍步行到教室大约需要 10 分钟。
